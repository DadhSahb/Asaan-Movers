    ...
    <>
      ...
      <Navbar bg="dark" variant="dark">
        <Container>
          ...
          <Navbar.Brand>Staff Login</Navbar.Brand>
      ...
      <main className="mainOfstaff">
        <div>
          <h1 className="d-flex justify-content-start mt-5">
            Customer Requests:
          </h1>
        </div>
        <div>
                    ...
                    <tr>
                      ...
                      <td className="text-right">
                        <Button className="btn btn-warning">
                          <i class="fa-solid fa-check" alt="Delete" />
                        </Button>{" "}
                        <Button className="btn btn-danger" alt="Edit">
                          <i class="fa-solid fa-xmark-large" alt="Delete" />
                        </Button>
                      </td>
                    </tr>
                  </tbody>
